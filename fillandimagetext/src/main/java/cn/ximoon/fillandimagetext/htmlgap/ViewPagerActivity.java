...
import cn.ximoon.fillandimagetext.R;
...
//                text1.setText("11111111");
                    ...
                    text1.setText(Html.fromHtml(list.get(position), new URLImageGetter(list.get(position), ViewPagerActivity.this, text1, options), new HtmlTagHandler(text1, rl, ViewPagerActivity.this,mClickController)));
